...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{http://realivanivani.github.io/}{realivanivani.github.io} & Mobile: \href{tel:+381642362210}{+3810642362210} \\
\end{tabular*}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {PhD in Computational Biolody and Bioinformatics; cum laude}{Oct 2010 -- Dec 2016}
    \resumeSubheading
...
\section{Skills}
  \resumeSubHeadingListStart
    \item{
      \textbf{Technologies}{: Python, SQL, Tableau, PowerBI, AWS}
      \hfill
      \textbf{Languages}{: English, Spanish, Czech, Russian (intermediate), Serbian (native)}
    }
%  \resumeSubHeadingListEnd
