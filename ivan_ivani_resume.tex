...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://realivanivani.github.io/}{\Large Ivan Ivani}} & Email: \href{mailto:jasamivanivani@gmail.com}{jasamivanivani@gmail.com}\\
  \href{http://realivanivani.github.io/}{realivanivani.github.io} & Mobile: \href{tel:+381642362210}{+381642362210} \\
\end{tabular*}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {PhD in Computational Chemistry and Bioinformatics; cum laude}{Oct 2010 -- Dec 2016}
    \resumeSubheading
      {Charles University}{Prague, Czechia}
      {MSc in Physics; GPA: 1.02 (top 2\% of class)}{Oct 2005 -- Jun 2010}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Senior Data Analyst}{Oct 2023 -- Present}
      \resumeItemListStartmisli
...
%-------------------------------------------
    ...
    \resumeSubheading
      {International Committee of the Red Cross}{Switzerland, Syria, Palestine, Venezuela}
      {Data Analyst}{Jun 2018 -- May 2023}
      \resumeItemListStart
    ...
    \resumeSubheading
      {Institute of Biomedicine}{Barcelona, Spain}
      {Researcher}{Oct 2010 - Dec 2017}
      \resumeItemListStart
...
\section{Skills}
  \resumeSubHeadingListStart
    \item{
      \textbf{Technologies}{: Python, SQL, Tableau, PowerBI, AWS, Machine Learning}
      \hfill
      \textbf{Languages}{: Fluently: English, Spanish, Czech, Serbian (Native). Communicative: Russian, German}
    }
%  \resumeSubHeadingListEnd
